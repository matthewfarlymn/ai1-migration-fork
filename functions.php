 ...
 * @return string
 */
function ai1m_storage_path( $params ) {
	if ( empty( $params['storage'] ) ) {
		throw new Ai1m_Storage_Exception( __( 'Unable to locate storage path. <a href="https://help.servmask.com/knowledgebase/invalid-storage-path/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ) );
	}
 ...
 * @return string
 */
function ai1m_backup_path( $params ) {
	if ( empty( $params['archive'] ) ) {
		throw new Ai1m_Archive_Exception( __( 'Unable to locate archive path. <a href="https://help.servmask.com/knowledgebase/invalid-archive-path/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ) );
	}

	// Validate archive path
	if ( validate_file( $params['archive'] ) !== 0 ) {
		throw new Ai1m_Archive_Exception( __( 'Invalid archive path. <a href="https://help.servmask.com/knowledgebase/invalid-archive-path/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ) );
	}
 ...
 * @return string
 */
function ai1m_archive_path( $params ) {
	if ( empty( $params['archive'] ) ) {
		throw new Ai1m_Archive_Exception( __( 'Unable to locate archive path. <a href="https://help.servmask.com/knowledgebase/invalid-archive-path/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ) );
	}
	...
	// Get archive path
	if ( empty( $params['ai1m_manual_restore'] ) ) {
		return ai1m_storage_path( $params ) . DIRECTORY_SEPARATOR . $params['archive'];
	}

	return ai1m_backup_path( $params );
}
 ...
 * @return string
 */
function ai1m_export_path( $params ) {
	return ai1m_storage_path( $params ) . DIRECTORY_SEPARATOR . AI1WM_EXPORT_NAME;
}
 ...
 * @return string
 */
function ai1m_import_path( $params ) {
	return ai1m_storage_path( $params ) . DIRECTORY_SEPARATOR . AI1WM_IMPORT_NAME;
}
 ...
 * @return string
 */
function ai1m_multipart_path( $params ) {
	return ai1m_storage_path( $params ) . DIRECTORY_SEPARATOR . AI1WM_MULTIPART_NAME;
}
 ...
 * @return string
 */
function ai1m_filemap_path( $params ) {
	return ai1m_storage_path( $params ) . DIRECTORY_SEPARATOR . AI1WM_FILEMAP_NAME;
}
 ...
 * @return string
 */
function ai1m_package_path( $params ) {
	return ai1m_storage_path( $params ) . DIRECTORY_SEPARATOR . AI1WM_PACKAGE_NAME;
}
 ...
 * @return string
 */
function ai1m_multisite_path( $params ) {
	return ai1m_storage_path( $params ) . DIRECTORY_SEPARATOR . AI1WM_MULTISITE_NAME;
}
 ...
 * @return string
 */
function ai1m_blogs_path( $params ) {
	return ai1m_storage_path( $params ) . DIRECTORY_SEPARATOR . AI1WM_BLOGS_NAME;
}
 ...
 * @return string
 */
function ai1m_settings_path( $params ) {
	return ai1m_storage_path( $params ) . DIRECTORY_SEPARATOR . AI1WM_SETTINGS_NAME;
}
 ...
 * @return string
 */
function ai1m_database_path( $params ) {
	return ai1m_storage_path( $params ) . DIRECTORY_SEPARATOR . AI1WM_DATABASE_NAME;
}
 ...
 * @return string
 */
function ai1m_content_path( $path = null ) {
	if ( empty( $path ) ) {
 ...
 * @return string
 */
function ai1m_archive_name( $params ) {
 ...
 * @return string
 */
function ai1m_backup_url( $params ) {
 ...
 * @return integer
 */
function ai1m_archive_bytes( $params ) {
	return filesize( ai1m_archive_path( $params ) );
}
 ...
 * @return integer
 */
function ai1m_backup_bytes( $params ) {
	return filesize( ai1m_backup_path( $params ) );
}
 ...
 * @return integer
 */
function ai1m_database_bytes( $params ) {
	return filesize( ai1m_database_path( $params ) );
}
 ...
 * @return integer
 */
function ai1m_package_bytes( $params ) {
	return filesize( ai1m_package_path( $params ) );
}
 ...
 * @return integer
 */
function ai1m_multisite_bytes( $params ) {
	return filesize( ai1m_multisite_path( $params ) );
}
 ...
 * @return string
 */
function ai1m_archive_size( $params ) {
	return size_format( filesize( ai1m_archive_path( $params ) ) );
}
 ...
 * @return string
 */
function ai1m_backup_size( $params ) {
	return size_format( filesize( ai1m_backup_path( $params ) ) );
}
 ...
 * @return string
 */
function ai1m_parse_size( $size, $default = null ) {
	$suffixes = array(
		''  => 1,
		'k' => 1000,
		'm' => 1000000,
 ...
 * @return string
 */
function ai1m_site_name( $blog_id = null ) {
 ...
 * @return string
 */
function ai1m_archive_file( $blog_id = null ) {
	$name = array();
 ...
 * @return string
 */
function ai1m_archive_folder( $blog_id = null ) {
	$name = array();
 ...
 * @return string
 */
function ai1m_archive_bucket( $blog_id = null ) {
	$name = array();
 ...
 * @return string
 */
function ai1m_archive_vault( $blog_id = null ) {
	$name = array();
 ...
 * @return string
 */
function ai1m_archive_project( $blog_id = null ) {
	$name = array();
 ...
 * @return string
 */
function ai1m_archive_share( $blog_id = null ) {
	$name = array();
 ...
 * @return boolean
 */
function ai1m_main_site( $blog_id = null ) {
 ...
 * @return string
 */
function ai1m_sites_path( $blog_id = null ) {
	if ( ai1m_main_site( $blog_id ) ) {
 ...
 * @return string
 */
function ai1m_files_path( $blog_id = null ) {
	if ( ai1m_main_site( $blog_id ) ) {
		return AI1WM_UPLOADS_PATH;
	}
 ...
 * @return string
 */
function ai1m_blogsdir_path( $blog_id = null ) {
	if ( ai1m_main_site( $blog_id ) ) {
 ...
 * @return string
 */
function ai1m_blogsdir_url( $blog_id = null ) {
	if ( ai1m_main_site( $blog_id ) ) {
 ...
 * @return string
 */
function ai1m_uploads_path( $blog_id = null ) {
	if ( ai1m_main_site( $blog_id ) ) {
		return '/wp-content/uploads/';
	}
 ...
 * @return string
 */
function ai1m_uploads_url( $blog_id = null ) {
	if ( ai1m_main_site( $blog_id ) ) {
		return get_site_url( $blog_id, '/wp-content/uploads/' );
	}
 ...
 * @return string
 */
function ai1m_servmask_prefix( $blog_id = null ) {
 ...
 * @return string
 */
function ai1m_table_prefix( $blog_id = null ) {
	global $wpdb;
 ...
 * @return array
 */
function ai1m_content_filters( $filters = array() ) {
...
function ai1m_plugin_filters( $filters = array() ) {
	...
	if ( defined( 'AI1WMZE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-azure-storage-extension';
	}
	...
	if ( defined( 'AI1WMAE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-b2-extension';
	}
	...
	if ( defined( 'AI1WMBE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-box-extension';
	}
	...
	if ( defined( 'AI1WMIE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-digitalocean-extension';
	}
	...
	if ( defined( 'AI1WMDE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-dropbox-extension';
	}
	...
	if ( defined( 'AI1WMFE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-ftp-extension';
	}
	...
	if ( defined( 'AI1WMCE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-gcloud-storage-extension';
	}
	...
	if ( defined( 'AI1WMGE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-gdrive-extension';
	}
	...
	if ( defined( 'AI1WMRE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-glacier-extension';
	}
	...
	if ( defined( 'AI1WMEE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-mega-extension';
	}
	...
	if ( defined( 'AI1WMME_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-multisite-extension';
	}
	...
	if ( defined( 'AI1WMOE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-onedrive-extension';
	}
	...
	if ( defined( 'AI1WMPE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-pcloud-extension';
	}
	...
	if ( defined( 'AI1WMSE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-s3-extension';
	}
	...
	if ( defined( 'AI1WMUE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-unlimited-extension';
	}
	...
	if ( defined( 'AI1WMLE_PLUGIN_BASENAME' ) ) {
		...
		$filters[] = 'plugins' . DIRECTORY_SEPARATOR . 'ai1-migration-url-extension';
	}
 ...
 * @return array
 */
function ai1m_active_servmask_plugins( $plugins = array() ) {
	// WP Migration Plugin
	if ( defined( 'AI1WM_PLUGIN_BASENAME' ) ) {
 ...
 * @return array
 */
function ai1m_active_sitewide_plugins() {
 ...
 * @return boolean
 */
function ai1m_activate_sitewide_plugins( $plugins ) {
 ...
 * @return boolean
 */
function ai1m_activate_plugins( $plugins ) {
 ...
 * @return string
 */
function ai1m_active_stylesheet() {
 ...
 * @return boolean
 */
function ai1m_activate_template( $template ) {
 ...
 * @return boolean
 */
function ai1m_activate_stylesheet( $stylesheet ) {
 ...
 * @return boolean
 */
function ai1m_deactivate_sitewide_plugins( $plugins ) {
	$current = get_site_option( AI1WM_ACTIVE_SITEWIDE_PLUGINS, array() );
 ...
 * @return boolean
 */
function ai1m_deactivate_plugins( $plugins ) {
	$current = get_option( AI1WM_ACTIVE_PLUGINS, array() );
 ...
 * @return boolean
 */
function ai1m_deactivate_jetpack_modules( $modules ) {
 ...
 * @return string
 */
function ai1m_discover_plugin_basename( $basename ) {
 ...
 * @return boolean
 */
function ai1m_validate_plugin_basename( $basename ) {
	if ( ( $plugins = get_plugins() ) ) {
		foreach ( $plugins as $plugin => $info ) {
			if ( $plugin === $basename ) {
				return true;
 ...
 * @return boolean
 */
function ai1m_validate_theme_basename( $basename ) {
 ...
 * @return string
 */
function ai1m_url_scheme( $url, $scheme = '' ) {
	if ( empty( $scheme ) ) {
 ...
 * @return resource
 * @throws Ai1m_Not_Accessible_Exception
 */
function ai1m_open( $file, $mode ) {
	$file_handle = @fopen( $file, $mode );
	if ( false === $file_handle ) {
		throw new Ai1m_Not_Accessible_Exception( sprintf( __( 'Unable to open %s with mode %s. <a href="https://help.servmask.com/knowledgebase/invalid-file-permissions/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ), $file, $mode ) );
	}
 ...
 * @return integer
 * @throws Ai1m_Not_Writable_Exception
 * @throws Ai1m_Quota_Exceeded_Exception
 */
function ai1m_write( $handle, $content ) {
	$write_result = @fwrite( $handle, $content );
	if ( false === $write_result ) {
		if ( ( $meta = stream_get_meta_data( $handle ) ) ) {
			throw new Ai1m_Not_Writable_Exception( sprintf( __( 'Unable to write to: %s. <a href="https://help.servmask.com/knowledgebase/invalid-file-permissions/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ), $meta['uri'] ) );
		}
	} elseif ( strlen( $content ) !== $write_result ) {
		if ( ( $meta = stream_get_meta_data( $handle ) ) ) {
			throw new Ai1m_Quota_Exceeded_Exception( sprintf( __( 'Out of disk space. Unable to write to: %s. <a href="https://help.servmask.com/knowledgebase/out-of-disk-space/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ), $meta['uri'] ) );
		}
	}
 ...
 * @return integer
 * @throws Ai1m_Not_Readable_Exception
 */
function ai1m_read( $handle, $filesize ) {
	$read_result = @fread( $handle, $filesize );
	if ( false === $read_result ) {
		if ( ( $meta = stream_get_meta_data( $handle ) ) ) {
			throw new Ai1m_Not_Readable_Exception( sprintf( __( 'Unable to read file: %s. <a href="https://help.servmask.com/knowledgebase/invalid-file-permissions/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ), $meta['uri'] ) );
		}
	}
 ...
 * @return integer
 */
function ai1m_seek( $handle, $offset, $mode = SEEK_SET ) {
	$seek_result = @fseek( $handle, $offset, $mode );
	if ( -1 === $seek_result ) {
		if ( ( $meta = stream_get_meta_data( $handle ) ) ) {
			throw new Ai1m_Not_Seekable_Exception( sprintf( __( 'Unable to seek to offset %d on %s. <a href="https://help.servmask.com/knowledgebase/php-32bit/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ), $offset, $meta['uri'] ) );
		}
	}
 ...
 * @return integer
 */
function ai1m_tell( $handle ) {
	$tell_result = @ftell( $handle );
	if ( false === $tell_result ) {
		if ( ( $meta = stream_get_meta_data( $handle ) ) ) {
			throw new Ai1m_Not_Tellable_Exception( sprintf( __( 'Unable to get current pointer position of %s. <a href="https://help.servmask.com/knowledgebase/php-32bit/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ), $meta['uri'] ) );
		}
	}
 ...
 * @return boolean
 */
function ai1m_touch( $file, $mtime ) {
 ...
 */
function ai1m_copy( $source_file, $destination_file ) {
	$source_handle      = ai1m_open( $source_file, 'rb' );
	$destination_handle = ai1m_open( $destination_file, 'ab' );
	while ( $buffer = ai1m_read( $source_handle, 4096 ) ) {
		ai1m_write( $destination_handle, $buffer );
	}
	ai1m_close( $source_handle );
	ai1m_close( $destination_handle );
}
 ...
 */
function ai1m_filesize( $file_path, $as_string = true ) {
	$chunk_size = 2000000; // 2MB
	$file_size  = new Math_BigInteger( 0 );

	try {
		$file_handle = ai1m_open( $file_path, 'rb' );

		while ( ! feof( $file_handle ) ) {
			$bytes     = ai1m_read( $file_handle, $chunk_size );
			$file_size = $file_size->add( new Math_BigInteger( strlen( $bytes ) ) );
		}

		ai1m_close( $file_handle );
 ...
 */
function ai1m_find_smaller_number( Math_BigInteger $a, Math_BigInteger $b ) {
	if ( $a->compare( $b ) === -1 ) {
		return $a;
	}
 ...
 */
function ai1m_is_filesize_supported( $file, $php_int_size = PHP_INT_SIZE, $php_int_max = PHP_INT_MAX ) {
	$size_result = true;
 ...
 */
function ai1m_fseek( $file_handle, Math_BigInteger $offset ) {
	$chunk_size = ai1m_find_smaller_number( new Math_BigInteger( 2000000 ), $offset );
	while ( ! feof( $file_handle ) && $offset->toString() != '0' ) {
		$bytes      = ai1m_read( $file_handle, $chunk_size->toInteger() );
		$offset     = $offset->subtract( new Math_BigInteger( strlen( $bytes ) ) );
		$chunk_size = ai1m_find_smaller_number( $chunk_size, $offset );
	}
}
 ...
 * @return boolean
 * @throws Ai1m_Not_Valid_Secret_Key_Exception
 */
function ai1m_verify_secret_key( $secret_key ) {
	if ( $secret_key !== get_option( AI1WM_SECRET_KEY ) ) {
		throw new Ai1m_Not_Valid_Secret_Key_Exception( __( 'Unable to authenticate the secret key. <a href="https://help.servmask.com/knowledgebase/invalid-secret-key/" target="_blank">Technical details</a>', AI1M_PLUGIN_NAME ) );
	}
 ...
 * @return boolean
 */
function ai1m_is_scheduled_backup() {
	if ( isset( $_GET['ai1m_manual_export'] ) || isset( $_POST['ai1m_manual_export'] ) ) {
		return false;
	}

	if ( isset( $_GET['ai1m_manual_import'] ) || isset( $_POST['ai1m_manual_import'] ) ) {
		return false;
	}

	if ( isset( $_GET['ai1m_manual_restore'] ) || isset( $_POST['ai1m_manual_restore'] ) ) {
		return false;
	}
 ...
 * @return void
 */
function ai1m_setup_environment() {
	...
	// Set error handler
	@set_error_handler( 'Ai1m_Handler::error' );

	// Set shutdown handler
	@register_shutdown_function( 'Ai1m_Handler::shutdown' );
}
