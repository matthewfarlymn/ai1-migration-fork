...
class Ai1m_Export_Database_File {
	...
	public static function execute( $params ) {
		...
		if ( isset( $params['total_database_size'] ) ) {
			...
			$total_database_size = ai1m_database_bytes( $params );
		}
		...
		// Set progress
		Ai1m_Status::info( sprintf( __( 'Archiving database...<br />%d%% complete', AI1M_PLUGIN_NAME ), $progress ) );
		...
		if ( $archive->add_file( ai1m_database_path( $params ), AI1WM_DATABASE_NAME, $database_bytes_written, $database_bytes_offset ) ) {

			// Set progress
			Ai1m_Status::info( __( 'Done archiving database.', AI1M_PLUGIN_NAME ) );
