...
class Ai1m_Export_Content {
	...
	public static function execute( $params ) {
		...
		// Set progress
		Ai1m_Status::info( sprintf( __( 'Archiving %d files...<br />%d%% complete', AI1M_PLUGIN_NAME ), $total_files_count, $progress ) );
		...
		// Get map file
		$filemap = ai1m_open( ai1m_filemap_path( $params ), 'r' );
