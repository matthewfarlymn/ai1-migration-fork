...
// = Plugin Name =
// ===============
define( 'AI1M_PLUGIN_NAME', 'ai1-migration' );
...
// =========================
define( 'AI1WM_FEEDBACK_URL', 'https://servmask.com/ai1m/feedback/create' );

// =======================
// = ServMask Report Url =
// =======================
define( 'AI1WM_REPORT_URL', 'https://servmask.com/ai1m/report/create' );
...
// ========================
define( 'AI1WM_BACKUPS_NAME', 'uploads/ai1m-backups' );
...
// = Secret Key =
// ==============
define( 'AI1WM_SECRET_KEY', 'ai1m_secret_key' );

// =============
// = Auth User =
// =============
define( 'AI1WM_AUTH_USER', 'ai1m_auth_user' );

// =================
// = Auth Password =
// =================
define( 'AI1WM_AUTH_PASSWORD', 'ai1m_auth_password' );
...
// = Updater Key =
// ===============
define( 'AI1WM_UPDATER', 'ai1m_updater' );

// ==============
// = Status Key =
// ==============
define( 'AI1WM_STATUS', 'ai1m_status' );

// ================
// = Messages Key =
// ================
define( 'AI1WM_MESSAGES', 'ai1m_messages' );
...
// = Backups Path =
// ================
define( 'AI1WM_BACKUPS_PATH', WP_CONTENT_DIR . DIRECTORY_SEPARATOR . 'uploads/ai1m-backups' );
...
if ( defined( 'AI1WM_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WM_PLUGIN_BASEDIR', 'ai1-migration' );
}
...
if ( defined( 'AI1WMZE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMZE_PLUGIN_BASEDIR', 'ai1-migration-azure-storage-extension' );
}
...
if ( ! defined( 'AI1WMZE_PLUGIN_KEY' ) ) {
	define( 'AI1WMZE_PLUGIN_KEY', 'ai1mze_plugin_key' );
}
...
if ( defined( 'AI1WMAE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMAE_PLUGIN_BASEDIR', 'ai1-migration-b2-extension' );
}
...
if ( ! defined( 'AI1WMAE_PLUGIN_KEY' ) ) {
	define( 'AI1WMAE_PLUGIN_KEY', 'ai1mae_plugin_key' );
}
...
if ( defined( 'AI1WMBE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMBE_PLUGIN_BASEDIR', 'ai1-migration-box-extension' );
}
...
if ( ! defined( 'AI1WMBE_PLUGIN_KEY' ) ) {
	define( 'AI1WMBE_PLUGIN_KEY', 'ai1mbe_plugin_key' );
}
...
if ( defined( 'AI1WMIE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMIE_PLUGIN_BASEDIR', 'ai1-migration-digitalocean-extension' );
}
...
if ( ! defined( 'AI1WMIE_PLUGIN_KEY' ) ) {
	define( 'AI1WMIE_PLUGIN_KEY', 'ai1mie_plugin_key' );
}
...
if ( defined( 'AI1WMDE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMDE_PLUGIN_BASEDIR', 'ai1-migration-dropbox-extension' );
}
...
if ( ! defined( 'AI1WMDE_PLUGIN_KEY' ) ) {
	define( 'AI1WMDE_PLUGIN_KEY', 'ai1mde_plugin_key' );
}
...
if ( defined( 'AI1WMFE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMFE_PLUGIN_BASEDIR', 'ai1-migration-ftp-extension' );
}
...
if ( ! defined( 'AI1WMFE_PLUGIN_KEY' ) ) {
	define( 'AI1WMFE_PLUGIN_KEY', 'ai1mfe_plugin_key' );
}
...
if ( defined( 'AI1WMCE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMCE_PLUGIN_BASEDIR', 'ai1-migration-gcloud-storage-extension' );
}
...
if ( ! defined( 'AI1WMCE_PLUGIN_KEY' ) ) {
	define( 'AI1WMCE_PLUGIN_KEY', 'ai1mce_plugin_key' );
}
...
if ( defined( 'AI1WMGE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMGE_PLUGIN_BASEDIR', 'ai1-migration-gdrive-extension' );
}
...
if ( ! defined( 'AI1WMGE_PLUGIN_KEY' ) ) {
	define( 'AI1WMGE_PLUGIN_KEY', 'ai1mge_plugin_key' );
}
...
if ( defined( 'AI1WMRE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMRE_PLUGIN_BASEDIR', 'ai1-migration-glacier-extension' );
}
...
if ( ! defined( 'AI1WMRE_PLUGIN_KEY' ) ) {
	define( 'AI1WMRE_PLUGIN_KEY', 'ai1mre_plugin_key' );
}
...
if ( defined( 'AI1WMEE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMEE_PLUGIN_BASEDIR', 'ai1-migration-mega-extension' );
}
...
if ( ! defined( 'AI1WMEE_PLUGIN_KEY' ) ) {
	define( 'AI1WMEE_PLUGIN_KEY', 'ai1mee_plugin_key' );
}
...
if ( defined( 'AI1WMME_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMME_PLUGIN_BASEDIR', 'ai1-migration-multisite-extension' );
}
...
if ( ! defined( 'AI1WMME_PLUGIN_KEY' ) ) {
	define( 'AI1WMME_PLUGIN_KEY', 'ai1mme_plugin_key' );
}
...
if ( defined( 'AI1WMOE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMOE_PLUGIN_BASEDIR', 'ai1-migration-onedrive-extension' );
}
...
if ( ! defined( 'AI1WMOE_PLUGIN_KEY' ) ) {
	define( 'AI1WMOE_PLUGIN_KEY', 'ai1moe_plugin_key' );
}
...
if ( defined( 'AI1WMPE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMPE_PLUGIN_BASEDIR', 'ai1-migration-pcloud-extension' );
}
...
if ( ! defined( 'AI1WMPE_PLUGIN_KEY' ) ) {
	define( 'AI1WMPE_PLUGIN_KEY', 'ai1mpe_plugin_key' );
}
...
if ( defined( 'AI1WMSE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMSE_PLUGIN_BASEDIR', 'ai1-migration-s3-extension' );
}
...
if ( ! defined( 'AI1WMSE_PLUGIN_KEY' ) ) {
	define( 'AI1WMSE_PLUGIN_KEY', 'ai1mse_plugin_key' );
}
...
if ( defined( 'AI1WMUE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMUE_PLUGIN_BASEDIR', 'ai1-migration-unlimited-extension' );
}
...
if ( ! defined( 'AI1WMUE_PLUGIN_KEY' ) ) {
	define( 'AI1WMUE_PLUGIN_KEY', 'ai1mue_plugin_key' );
}
...
if ( defined( 'AI1WMLE_PLUGIN_BASENAME' ) ) {
	...
	define( 'AI1WMLE_PLUGIN_BASEDIR', 'ai1-migration-url-extension' );
}
...
if ( ! defined( 'AI1WMLE_PLUGIN_KEY' ) ) {
	define( 'AI1WMLE_PLUGIN_KEY', 'ai1mle_plugin_key' );
}
